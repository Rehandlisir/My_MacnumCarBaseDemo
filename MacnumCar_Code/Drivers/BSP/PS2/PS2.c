...
void  PS2_CapData(void)
{
	...
	/*左手柄数据处理*/
	if(s_ps2data.LEFT_X>118 && s_ps2data.LEFT_X<138)
	{
		s_ps2data.LEFT_X = 128;
	}

	if (s_ps2data.LEFT_Y>118 && s_ps2data.LEFT_Y<138)
	{
	...
	/*右手柄数据处理*/
	if(s_ps2data.RIGHT_X>118 && s_ps2data.RIGHT_X<138 )
	{
		s_ps2data.RIGHT_X = 128;
	}

	if (s_ps2data.RIGHT_Y>118 && s_ps2data.RIGHT_Y<138)
	{
